...
!function (t, i) {
    ...
    var Qt = Object.create || function () {
        ...
        }, ni = "data:image/gif;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs=", oi = 0,
    ...
    var pi, mi, fi, gi, vi = i({}, _i, {
        ...
        bi = A("webkit"), Ti = A("android"), zi = A("android 2") || A("android 3"),
        Mi = parseInt(/WebKit\/([0-9]+)|$/.exec(navigator.userAgent)[1], 10),
        Ci = Ti && A("Google") && Mi < 537 && !("AudioNode" in window), Zi = !!window.opera, Si = A("chrome"),
        Ei = A("gecko") && !bi && !Zi && !wi, ki = !Si && A("safari"), Ai = A("phantom"), Ii = "OTransition" in xi,
        ...
        ji = "undefined" != typeof orientation || A("mobile"), Wi = ji && bi, Hi = ji && Ri,
    ...
    var Me = Pe.extend({
        ...
        options: {
            ...
            prefix: '<a href="../../leafletjs.com/index.htm" title="A JS library for interactive maps">Leaflet</a>'
